...
public class DataModel {
    ...
    private static final String PREFERENCE_KEY_CMS_API_URL = "preference_key_cms_api_url";
    private static final String PREFERENCE_KEY_DNS_SERVER = "preference_key_dns_server";

    // Defaults
    public static final String DEFAULT_CMS_URL = "https://your-api-server.com";
    ...
    public void setAutoLogin(Context context, Boolean auto) {
        context.getSharedPreferences(APP_PREFERENCE, Context.MODE_PRIVATE).edit()
                .putBoolean(PREFERENCE_KEY_AUTO_LOGIN, auto).apply();
    }

    public Boolean isAutoLogin(Context context) {
        return context.getSharedPreferences(APP_PREFERENCE, Context.MODE_PRIVATE).getBoolean(PREFERENCE_KEY_AUTO_LOGIN,
                DEFAULT_AUTO_LOGIN);
    }

    public void setLastPlayUrl(Context context, String url) {
        context.getSharedPreferences(APP_PREFERENCE, Context.MODE_PRIVATE).edit()
                .putString(PREFERENCE_KEY_LAST_PLAY_URL, url).apply();
    }

    public String getLastPlayUrl(Context context) {
        return context.getSharedPreferences(APP_PREFERENCE, Context.MODE_PRIVATE)
                .getString(PREFERENCE_KEY_LAST_PLAY_URL, "");
    }

    public void setLastPlayName(Context context, String name) {
        context.getSharedPreferences(APP_PREFERENCE, Context.MODE_PRIVATE).edit()
                .putString(PREFERENCE_KEY_LAST_PLAY_NAME, name).apply();
    }

    public String getLastPlayName(Context context) {
        return context.getSharedPreferences(APP_PREFERENCE, Context.MODE_PRIVATE)
                .getString(PREFERENCE_KEY_LAST_PLAY_NAME, "");
    }

    public void setCmsApiUrl(Context context, String url) {
        save(context, PREFERENCE_KEY_CMS_API_URL, url);
    }

    public String getCmsApiUrl(Context context) {
        return get(context, PREFERENCE_KEY_CMS_API_URL, DEFAULT_CMS_URL);
    }

    public void setDnsServer(Context context, String dns) {
        save(context, PREFERENCE_KEY_DNS_SERVER, dns);
    }

    public String getDnsServer(Context context) {
        return get(context, PREFERENCE_KEY_DNS_SERVER, DEFAULT_DNS_SERVER);
    }
