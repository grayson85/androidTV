...
//import com.gs.ijkplayer.R;
import com.gs.ijkplayer.widget.media.IRenderView;
import com.gs.ijkplayer.widget.media.IjkVideoView;
...
//            $.id(R.id.app_video_loading).visible();
    ...
    public class PlayerGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            Log.wtf("PlayerManager","toSeek:"+toSeek);
            if (toSeek) {
                if (!isLive) {
                    Log.wtf("PlayerManager","onProgressSlide");
