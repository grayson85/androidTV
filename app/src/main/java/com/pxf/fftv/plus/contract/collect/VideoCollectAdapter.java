...
public class VideoCollectAdapter extends RecyclerView.Adapter<VideoCollectAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            video_collect_card_root = itemView.findViewById(R.id.video_collect_card_root);
            video_collect_card_image = itemView.findViewById(R.id.video_collect_card_image);
            video_collect_card_text = itemView.findViewById(R.id.video_collect_card_text);
        }
    }
}
