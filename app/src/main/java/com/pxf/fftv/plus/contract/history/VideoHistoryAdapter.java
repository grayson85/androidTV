...
public class VideoHistoryAdapter extends RecyclerView.Adapter<VideoHistoryAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            video_history_card_root = itemView.findViewById(R.id.video_history_card_root);
            video_history_card_image = itemView.findViewById(R.id.video_history_card_image);
            video_history_card_text = itemView.findViewById(R.id.video_history_card_text);
            video_history_card_progress = itemView.findViewById(R.id.video_history_card_progress);
        }
    }
}
