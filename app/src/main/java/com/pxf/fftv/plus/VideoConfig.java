...
public class VideoConfig {
    ...
    private static final String BASE_CMS_URL = Const.BASE_URL + "/api.php/provide/vod/?ac=videolist";
    ...
    public static final Video1[] VIDEO_CONFIG_CMS = new Video1[]{
            new Video1("精选", true, false, new Video2[]{
                    new Video2("电影", "电影", BASE_CMS_URL + "&lvl=2"),
                    new Video2("电视", "电视", BASE_CMS_URL + "&lvl=3"),
                    new Video2("综艺", "综艺", BASE_CMS_URL + "&lvl=4"),
                    new Video2("动漫", "动漫", BASE_CMS_URL + "&lvl=5"),
            }),
            new Video1("电影", false, false, new Video2[]{
                    new Video2("新片上架", "最新电影", BASE_CMS_URL + "&t1=1"),
                    new Video2("动作", "动作电影", BASE_CMS_URL + "&t=6"),
                    new Video2("喜剧", "喜剧电影", BASE_CMS_URL + "&t=7"),
                    new Video2("爱情", "爱情电影", BASE_CMS_URL + "&t=8"),
                    new Video2("科幻", "科幻电影", BASE_CMS_URL + "&t=9"),
                    new Video2("恐怖", "恐怖电影", BASE_CMS_URL + "&t=10"),
                    new Video2("剧情", "剧情电影", BASE_CMS_URL + "&t=11"),
                    new Video2("战争", "战争电影", BASE_CMS_URL + "&t=12"),
                    new Video2("纪录", "纪录电影", BASE_CMS_URL + "&t=21"),
                    new Video2("犯罪", "犯罪电影", BASE_CMS_URL + "&t=22"),
                    new Video2("悬疑", "悬疑电影", BASE_CMS_URL + "&t=23"),
                    new Video2("动画", "动画电影", BASE_CMS_URL + "&t=24"),
                    new Video2("奇幻", "奇幻电影", BASE_CMS_URL + "&t=38"),
                    new Video2("其他", "其他电影", BASE_CMS_URL + "&t=25")
            }),
            new Video1("电视剧", false, false, new Video2[]{
                    new Video2("新剧上新", "最新剧集", BASE_CMS_URL + "&t1=2"),
                    new Video2("国产剧集", "国产剧集", BASE_CMS_URL + "&t=13"),
                    new Video2("香港剧集", "香港剧集", BASE_CMS_URL + "&t=14"),
                    new Video2("韩国剧集", "韩国剧集", BASE_CMS_URL + "&t=15"),
                    new Video2("日本剧集", "日本剧集", BASE_CMS_URL + "&t=16"),
                    new Video2("台湾剧集", "台湾剧集", BASE_CMS_URL + "&t=26"),
                    new Video2("欧美剧集", "欧美剧集", BASE_CMS_URL + "&t=27"),
                    new Video2("其他剧集", "其他剧集", BASE_CMS_URL + "&t=29"),
            }),
            new Video1("综艺", false, false, new Video2[]{
                    new Video2("最新综艺", "最新综艺", BASE_CMS_URL + "&t1=3"),
                    new Video2("大陆综艺", "大陆综艺", BASE_CMS_URL + "&t=30"),
                    new Video2("日韩综艺", "日韩综艺", BASE_CMS_URL + "&t=31"),
                    new Video2("港台综艺", "港台综艺", BASE_CMS_URL + "&t=32"),
                    new Video2("欧美综艺", "欧美综艺", BASE_CMS_URL + "&t=33")
            }),
            new Video1("动漫", false, false, new Video2[]{
                    new Video2("最新动漫", "最新动漫", BASE_CMS_URL + "&t1=4"),
                    new Video2("大陆动漫", "大陆动漫", BASE_CMS_URL + "&t=34"),
                    new Video2("日韩动漫", "日韩动漫", BASE_CMS_URL + "&t=35"),
                    new Video2("欧美动漫", "欧美动漫", BASE_CMS_URL + "&t=36")
            })
    };
    ...
    public static final VideoScreen[] VIDEO_SCREEN_CMS = new VideoScreen[]{
            new VideoScreen(
                    ...
                    new VideoScreenSub[]{
                            ...
                            new VideoScreenSub("纪录", "&t=21"),
                            new VideoScreenSub("犯罪", "&t=22"),
                            new VideoScreenSub("悬疑", "&t=23"),
                            new VideoScreenSub("动画", "&t=24"),
                            new VideoScreenSub("奇幻", "&t=38"),
                            new VideoScreenSub("其他", "&t=25")
                    },
            ...
            new VideoScreen(
                    "电视", BASE_CMS_URL,
                    new VideoScreenSub[]{
                            new VideoScreenSub("全部", "&t1=2"),
                            new VideoScreenSub("国产剧", "&t=13"),
                            new VideoScreenSub("港剧", "&t=14"),
                            new VideoScreenSub("韩剧", "&t=15"),
                            new VideoScreenSub("日剧", "&t=16"),
                            new VideoScreenSub("台湾剧", "&t=26"),
                            new VideoScreenSub("欧美剧", "&t=27"),
                            new VideoScreenSub("其他剧", "&t=29")
                    },
                    VIDEO_SCREEN_CMS_YEAR,
                    new VideoScreenSub[]{},
                    VIDEO_SCREEN_CMS_LANG,
            ...
            new VideoScreen(
                    "综艺", BASE_CMS_URL,
                    new VideoScreenSub[]{
                            new VideoScreenSub("全部", "&t1=3"),
                            new VideoScreenSub("大陆综艺", "&t=30"),
                            new VideoScreenSub("日韩综艺", "&t=31"),
                            new VideoScreenSub("港台综艺", "&t=32"),
                            new VideoScreenSub("欧美综艺", "&t=33")
                    },
                    VIDEO_SCREEN_CMS_YEAR,
                    new VideoScreenSub[]{},
                    VIDEO_SCREEN_CMS_LANG,
            ...
            new VideoScreen(
                    "动漫", BASE_CMS_URL,
                    new VideoScreenSub[]{
                            new VideoScreenSub("全部", "&t1=4"),
                            new VideoScreenSub("大陆动漫", "&t=34"),
                            new VideoScreenSub("日韩动漫", "&t=35"),
                            new VideoScreenSub("欧美动漫", "&t=36")
                    },
                    VIDEO_SCREEN_CMS_YEAR,
                    new VideoScreenSub[]{},
                    VIDEO_SCREEN_CMS_LANG,
