...
public class NativePlayerActivity extends AppCompatActivity {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (!isFinishing()) {
                                    ...
                                    video_time.setText(
                                            formatTime(videoView.getCurrentPosition() / 1000) + " / "
                                                    + formatTime(videoView.getDuration() / 1000));
                                }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                if (menuRoot.getVisibility() == View.GONE) {
                    ...
                    // Native player mostly has just switch button or no buttons, try to find a
                    // focusable view
                    View focusView = findViewById(R.id.btn_switch_player);
                    if (focusView != null) {
            ...
            case KeyEvent.KEYCODE_CTRL_LEFT:
                ...
                if (!mProgressDialog.isShowing()) {
                    ...
                    Window dialogWindow = mProgressDialog
                            .getWindow();
    ...
    private void showSwitchPlayerDialog() {
        ...
        ModernDialog.showList(this, "选择播放器", items, position -> {
            Model.getData().setPlayerEngine(NativePlayerActivity.this, engines[position]);
            Toast.makeText(NativePlayerActivity.this, "已切换为 " + items[position], Toast.LENGTH_SHORT).show();
            ...
            IVideoPlayer player = VideoPlayer.getVideoPlayer(NativePlayerActivity.this);
            player.play(NativePlayerActivity.this, videoUrl, title, subTitle, currentPartPosition, picUrl,
