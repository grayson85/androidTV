...
public class SearchActivity extends Activity implements SearchAdapter.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_iv_search = findViewById(R.id.search_iv_search);
        search_et_input = findViewById(R.id.search_et_input);
        search_recycler_view_result = findViewById(R.id.search_recycler_view_result);
        search_tv_no_result = findViewById(R.id.search_tv_no_result);

        search_iv_search.setOnClickListener(v -> onSearchClick());
