...
public class VipPayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vip_pay_root = findViewById(R.id.vip_pay_root);
        vip_pay_tv_title = findViewById(R.id.vip_pay_tv_title);
        vip_pay_iv_qrcode_ali = findViewById(R.id.vip_pay_iv_qrcode_ali);
        vip_pay_iv_qrcode_wx = findViewById(R.id.vip_pay_iv_qrcode_wx);
        vip_pay_iv_qrcode_qq = findViewById(R.id.vip_pay_iv_qrcode_qq);
            ...
            public void run() {
                ...
                Observable
                        .create((ObservableOnSubscribe<Boolean>) emitter -> {
                            Response response = null;
                            try {
                                String requestBody = "token=" + FFTVApplication.token + "&orderno=" + order
                                        + "&tianshu=" + addSecond;
                                MediaType mediaType = MediaType.parse("application/x-www-form-urlencoded");
                                RequestBody body = RequestBody.create(mediaType, requestBody);
                                final Request request = new Request.Builder()
