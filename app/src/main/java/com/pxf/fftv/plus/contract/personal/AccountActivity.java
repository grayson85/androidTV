...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        account_et_login_account = findViewById(R.id.account_et_login_account);
        account_et_login_password = findViewById(R.id.account_et_login_password);
        account_tv_login = findViewById(R.id.account_tv_login);
        account_tv_start_register = findViewById(R.id.account_tv_start_register);
        account_et_register_account = findViewById(R.id.account_et_register_account);
        account_et_register_password = findViewById(R.id.account_et_register_password);
        account_et_register_password_again = findViewById(R.id.account_et_register_password_again);
        account_tv_register = findViewById(R.id.account_tv_register);
        account_root_login = findViewById(R.id.account_root_login);
        account_root_register = findViewById(R.id.account_root_register);
        account_root_have_login = findViewById(R.id.account_root_have_login);
        account_tv_account_name = findViewById(R.id.account_tv_account_name);
        account_tv_buy_vip = findViewById(R.id.account_tv_buy_vip);
        account_tv_vip = findViewById(R.id.account_tv_vip);
        account_vip_date = findViewById(R.id.account_vip_date);
        account_tv_logout = findViewById(R.id.account_tv_logout);
        account_tv_switch_account = findViewById(R.id.account_tv_switch_account);

        account_tv_start_register.setOnClickListener(v -> onStartRegisterClick());
        account_tv_register.setOnClickListener(v -> onRegisterClick());
        account_tv_login.setOnClickListener(v -> onLoginClick());
        account_tv_logout.setOnClickListener(v -> onLogoutClick());
        account_tv_switch_account.setOnClickListener(v -> onSwitchAccountClick());
