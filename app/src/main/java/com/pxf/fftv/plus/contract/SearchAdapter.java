...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            search_item_iv_pic = itemView.findViewById(R.id.search_item_iv_pic);
            search_item_tv_name = itemView.findViewById(R.id.search_item_tv_name);
            search_item_tv_director = itemView.findViewById(R.id.search_item_tv_director);
            search_item_tv_actor = itemView.findViewById(R.id.search_item_tv_actor);
            search_item_tv_area = itemView.findViewById(R.id.search_item_tv_area);
            search_item_tv_year = itemView.findViewById(R.id.search_item_tv_year);
            search_item_tv_content = itemView.findViewById(R.id.search_item_tv_content);
        }
    }
